...
window.installSheetWorkspace = function(b) {
  ...
  toolbar.innerHTML = '<div class="sw-top"><div><span class="sw-eyebrow">LIVE GANG SHEET</span><h2>Your print, coming together.</h2></div><button id="sw-arrange" type="button" title="Rearrange all pieces for a new layout">Auto-arrange</button></div>' +
